...
class MyApp(App):
    ...
    def main(self):
        ...
        self.label = gui.Label("Type an English word to translate!", width=300, height=10,
        ...
        self.button = gui.Button("TRANSLATE", width=300, height=40, margin="10px",
                                 style={"background-color": "#F16059", "font-weight": "bold", "font-size": "16px",
                                        "box-shadow": "none"})
